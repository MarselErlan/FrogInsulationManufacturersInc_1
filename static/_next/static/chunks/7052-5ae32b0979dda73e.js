	...
	[7052], {
		7052: function(e, s, a) {
			...
			function o(e, s) {
				switch (s.type) {
					case "TOGGLE":
						if (e.activeMenu === s.payload) return { ...e,
							activeMenu: "",
							menuOpen: !e.menuOpen
						};
						return { ...e,
							activeMenu: s.payload,
							menuOpen: !e.menuOpen
						};
					case "HOME_ONE":
						return { ...e,
			...
			s.Z = function() {
				let [e, s] = (0, r.useReducer)(o, d), a = (0, r.useRef)(null), l = () => {
					let {
						scrollY: e
					} = window;
					s({
				...
				}(0, r.useEffect)(() => (window.addEventListener("scroll", l), () => {
					window.removeEventListener("scroll", l)
				}), []);
				let C = (0, c.useRouter)().pathname;
				return (0, r.useEffect)(() => {
					let e = document.querySelector(".mobile-menu-btn"),
						s = document.querySelector(".main-menu"),
						a = document.querySelector(".menu-close-btn");
					e.addEventListener("click", () => {
						s.classList.add("show-menu")
					}), a.addEventListener("click", () => {
						s.classList.remove("show-menu")
					})
				}), (0, i.jsxs)("header", {
					ref: a,
					className: e.scrollY > 120 ? "header-area style-2 sticky" : "header-area style-2",
					children: [(0, i.jsx)("div", {
						...
						children: [(0, i.jsxs)("div", {
							className: "top-bar",
							children: [(0, i.jsxs)("p", {
								children: ["Welcome Our Job Portal!", " ", (0, i.jsx)(n(), {
									legacyBehavior: !0,
								...
								children: [(0, i.jsxs)("div", {
									...
									children: [(0, i.jsxs)("li", {
										...
										children: [(0, i.jsx)("a", {
											...
											className: "home-one" === e.activeMenu ? "sub-menu d-block" : "sub-menu",
											children: [(0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													legacyBehavior: !0,
													href: "/",
										...
										className: "/category" === C || "/job-listing1" === C || "/job-details" === C ? "menu-item-has-children active" : "",
										children: [(0, i.jsx)("a", {
											href: "#",
											className: "drop-down",
											children: "Find Jobs"
											...
											className: "bi bi-plus dropdown-icon",
											onClick: () => h("job-category.html")
										}), (0, i.jsxs)("ul", {
											className: "job-category.html" === e.activeMenu ? "sub-menu d-block" : "sub-menu",
											children: [(0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													legacyBehavior: !0,
													href: "/category",
												...
												children: (0, i.jsx)(n(), {
													...
													href: "/job-listing1",
													children: (0, i.jsx)("a", {
														className: "/job-listing1" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													href: "/job-details",
													children: (0, i.jsx)("a", {
														className: "/job-details" === C ? "active" : "",
										...
										className: "/candidates-dashboard/dashboard" === C || "/job-post" === C || "/faq" === C || "/candidates-dashboard/view-resume" === C || "/candidates-dashboard/settings" === C || "/candidates-dashboard/edit-profile" === C || "/candidates-dashboard/bookmark" === C || "/candidates-dashboard/my-profile" === C || "/candidates-dashboard/applied-job" === C || "/register" === C || "/pricing-plan" === C ? "menu-item-has-children active" : "",
										children: [(0, i.jsx)("a", {
											href: "#",
											className: "drop-down",
											children: "Pages"
											...
											className: "pages" === e.activeMenu ? "sub-menu d-block" : "sub-menu",
											children: [(0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													legacyBehavior: !0,
													href: "/candidates-dashboard/dashboard",
													children: (0, i.jsx)("a", {
														className: "/candidates-dashboard/dashboard" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													href: "/pricing-plan",
													children: (0, i.jsx)("a", {
														className: "/pricing-plan" === C ? "active" : "",
										...
										className: "/company-listing1" === C || "/company-details" === C || "/company/company-dashboard" === C || "/company/company-profile" === C || "/company/company-job-list" === C || "/company/plans-billing" === C || "/company/company-setting" === C || "/company/company-dashboard" === C ? "menu-item-has-children active" : "",
										children: [(0, i.jsx)("a", {
											href: "#",
											children: "Employers"
										}), (0, i.jsx)("i", {
											...
											className: "company" === e.activeMenu ? "sub-menu d-block" : "sub-menu",
											children: [(0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													legacyBehavior: !0,
													href: "/company-listing1",
													children: (0, i.jsx)("a", {
														className: "/company-listing1" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													children: (0, i.jsx)("a", {
														className: "/company-details" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													children: (0, i.jsx)("a", {
														className: "/company/company-dashboard" === C ? "active" : "",
										...
										className: "/blog-grid" === C || "/blog-right-sidebar" === C || "/blog-details" === C || "/blog-standard" === C ? "menu-item-has-children active" : "",
										children: [(0, i.jsx)("a", {
											href: "#",
											children: "Blog"
										}), (0, i.jsx)("i", {
											...
											className: "blog" === e.activeMenu ? "sub-menu d-block" : "sub-menu",
											children: [(0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													legacyBehavior: !0,
													href: "/blog-grid",
													children: (0, i.jsx)("a", {
														className: "/bolg-grid" === C ? "active" : "",
														children: "Blog Grid"
													})
												})
											}), (0, i.jsx)("li", {
												children: (0, i.jsx)(n(), {
													...
													children: (0, i.jsx)("a", {
														className: "/blog-right-sidebar" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													href: "/blog-standard",
													children: (0, i.jsx)("a", {
														className: "/blog-standard" === C ? "active" : "",
												...
												children: (0, i.jsx)(n(), {
													...
													href: "/blog-details",
													children: (0, i.jsx)("a", {
														className: "/blog-details" === C ? "active" : "",
